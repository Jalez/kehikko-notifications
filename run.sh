...
#     that picked its own would answer somewhere nobody is looking. 7910 is the
#     default and it is the number in the registration too — 7820, 7830, 7840,
#     7850 and 7860 belong to the other modules on this machine.
...
exec bunx vite --host 127.0.0.1 --port "${PORT:-7910}" --strictPort
